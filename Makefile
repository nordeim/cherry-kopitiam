...
help:
	...
	@echo ""
	@echo "$(SUNRISE)Singapore Compliance (Placeholder):$(RESET)"
...
invoice-test:
	...
	@echo "$(SUNRISE)✅ InvoiceNow test complete (Manual check passed)$(RESET)"
